...
namespace WatchersNET.CKEditor.Objects
{
    ...
    public class EditorConfig
    {
        ...
        public EditorConfig()
        {
            ...
            this.ExtraPlugins =
                "autosave,mathjax,embed,tableresize,textselection,notification,stylesheetparser,qrcodes,newsarticleslinks,codemirror,codesnippet,dnnpages,xmltemplates,wordcount";
