...
namespace WatchersNET.CKEditor.Module
{
    ...
    public partial class EditorConfigManager : ModuleSettingsBase
    {
        ...
        private void AddJavaScripts()
        {
            ...
            if (scriptHolder != null)
            {
                var objCssLink = new HtmlGenericControl("link");
                ...
                var notificationCssLink = new HtmlGenericControl("link");

                notificationCssLink.Attributes["rel"] = "stylesheet";
                notificationCssLink.Attributes["type"] = "text/css";
                notificationCssLink.Attributes["href"] = this.ResolveUrl("~/Providers/HtmlEditorProviders/CKEditor/css/jquery.notification.css");

                scriptHolder.Controls.Add(notificationCssLink);

                var optionsCssLink = new HtmlGenericControl("link");

                optionsCssLink.Attributes["rel"] = "stylesheet";
                optionsCssLink.Attributes["type"] = "text/css";
                optionsCssLink.Attributes["href"] = this.ResolveUrl("~/Providers/HtmlEditorProviders/CKEditor/css/Options.css");

                scriptHolder.Controls.Add(optionsCssLink);
            }
            else
            {
        ...
        private void BindPortalTabsAndModulesTree()
        {
            ...
            var settingsDictionary = HostController.Instance.GetSettingsDictionary();//Host.GetHostSettingsDictionary();
