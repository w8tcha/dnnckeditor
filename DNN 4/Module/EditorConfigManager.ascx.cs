    ...
    public partial class EditorConfigManager : ModuleSettingsBase
    {
        ...
        private void PortalTabsAndModulesTree_SelectedNodeChanged(object sender, EventArgs e)
        {
            ...
            if (this.PortalTabsAndModulesTree.SelectedValue.StartsWith("p"))
            {
                ...
                // Load Settings
                this.EditorOptions.BindOptionsData();
            }
        ...
        {
            /*ClientResourceManager.RegisterStyleSheet(this.Page, this.ResolveUrl("~/Providers/HtmlEditorProviders/CKEditor/css/jquery.notification.css"));

            ClientResourceManager.RegisterStyleSheet(
                this.Page, "//ajax.googleapis.com/ajax/libs/jqueryui/1/themes/blitzer/jquery-ui.css");
             
            ClientResourceManager.RegisterStyleSheet(this.Page, this.ResolveUrl("~/Providers/HtmlEditorProviders/CKEditor/css/Options.css"));
            */
            ...
            ScriptManager.RegisterClientScriptInclude(
                ...
                this.pageType,
                "jquery.ui.controls",
                this.ResolveUrl("~/Providers/HtmlEditorProviders/CKEditor/js/jquery.ui.controls.js"));
        ...
        private void BindPortalTabsAndModulesTree()
        {
            ...
            var settingsDictionary = PortalSettings.HostSettings;
        ...
        private void RenderPortalNode(
            PortalInfo portal, ModuleController moduleController, Hashtable settingsDictionary)
        {
            ...
            foreach (TabInfo tabInfo in tabController.GetTabsByParentId(-1, portal.PortalID))
            {
                this.RenderTabNode(portalNode, tabInfo, moduleController, tabController, settingsDictionary);
            }
            ...
            Hashtable settingsDictionary)
        {
            ...
            {
                foreach (TabInfo childTab in tabController.GetTabsByParentId(tabInfo.TabID, tabInfo.PortalID))
                {
                    this.RenderTabNode(tabNode, childTab, moduleController, tabController, settingsDictionary);
                }
            }
