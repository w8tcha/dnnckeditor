...
<style type="text/css">
    .groupButtons li {margin-left:-30px!important}
</style>
  ...
  <table style="width:100%;">
    ...
    <table id="tblMainSet">
      <tr>
	    ...
	    <td class="settingValueColumn"><asp:TextBox runat="server" id="txtBlanktext" Width="395px"></asp:TextBox></td>
      </tr>
      <tr>
	      ...
	      <asp:GridView id="gvToolbars" runat="server" AutoGenerateColumns="False" Width="400px" GridLines="None" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false" HeaderStyle-Font-Italic="true">
            <Columns>
              ...
              <asp:TemplateField>
                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                <HeaderTemplate>
                  <asp:Label id="lblSelToolb" runat="server" Text="Select a Toolbar"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
    ...
    <table>
      ...
      <tr>
       ...
       <tr>
        ...
        <td class="settingValueColumn"><asp:TextBox ID="txtResizeHeight" runat="server" CssClass="settingValueInputNumeric"></asp:TextBox>px</td>
      </tr>
      <tr>
